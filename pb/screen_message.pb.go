...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=v1.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x22, 0x89, 0x02, 0x0a, 0x06, 0x53,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x63,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x77, 0x69, 0x64, 0x74, 0x68, 0x22, 0x27, 0x0a,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: v1.Screen.Panel
	(*Screen)(nil),            // 1: v1.Screen
	(*Screen_Resolution)(nil), // 2: v1.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: v1.Screen.resolution:type_name -> v1.Screen.Resolution
	0, // 1: v1.Screen.panel:type_name -> v1.Screen.Panel
