...
type CreateLaptopRequest struct {
	...
	Laptop *Laptop `protobuf:"bytes,1,opt,name=laptop,proto3" json:"laptop,omitempty"` // laptop
}
...
type CreateLaptopResponse struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // laptop created id
}
...
type UploadImageRequest_ChunckData struct {
	ChunckData []byte `protobuf:"bytes,2,opt,name=chunck_data,json=chunckData,proto3,oneof"`
}
...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a, 0x14, 0x6c, 0x61, 0x70, 0x74,
	...
	0x76, 0x31, 0x2e, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x06, 0x6c, 0x61, 0x70, 0x74, 0x6f,
	...
	0x32, 0x0a, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x06, 0x66, 0x69,
	...
	,
	...
	0x65, 0x22, 0x5b, 0x0a, 0x09, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1b,
	...
	0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61,
	0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x32, 0xdf,
	...
	,
...
var file_laptop_service_proto_goTypes = []interface{}{
	(*CreateLaptopRequest)(nil),  // 0: v1.CreateLaptopRequest
	(*CreateLaptopResponse)(nil), // 1: v1.CreateLaptopResponse
	(*SearchLaptopRequest)(nil),  // 2: v1.SearchLaptopRequest
	(*SearchLaptopResponse)(nil), // 3: v1.SearchLaptopResponse
	(*UploadImageRequest)(nil),   // 4: v1.UploadImageRequest
	(*UploadImageResponse)(nil),  // 5: v1.UploadImageResponse
	(*ImageInfo)(nil),            // 6: v1.ImageInfo
	(*Laptop)(nil),               // 7: v1.Laptop
	(*Filter)(nil),               // 8: v1.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	7, // 0: v1.CreateLaptopRequest.laptop:type_name -> v1.Laptop
	8, // 1: v1.SearchLaptopRequest.filter:type_name -> v1.Filter
	7, // 2: v1.SearchLaptopResponse.laptop:type_name -> v1.Laptop
	6, // 3: v1.UploadImageRequest.info:type_name -> v1.ImageInfo
	0, // 4: v1.LaptopService.CreateLaptop:input_type -> v1.CreateLaptopRequest
	2, // 5: v1.LaptopService.SearchLaptop:input_type -> v1.SearchLaptopRequest
	4, // 6: v1.LaptopService.UploadImage:input_type -> v1.UploadImageRequest
	1, // 7: v1.LaptopService.CreateLaptop:output_type -> v1.CreateLaptopResponse
	3, // 8: v1.LaptopService.SearchLaptop:output_type -> v1.SearchLaptopResponse
	5, // 9: v1.LaptopService.UploadImage:output_type -> v1.UploadImageResponse
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreateLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *laptopServiceClient) SearchLaptop(ctx context.Context, in *SearchLaptopRequest, opts ...grpc.CallOption) (LaptopService_SearchLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &_LaptopService_serviceDesc.Streams[0], "/v1.LaptopService/SearchLaptop", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *laptopServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (LaptopService_UploadImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &_LaptopService_serviceDesc.Streams[1], "/v1.LaptopService/UploadImage", opts...)
	if err != nil {
		return nil, err
	}
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.LaptopService/CreateLaptop",
	}
