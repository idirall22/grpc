...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=v1.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a, 0x14, 0x6d, 0x65, 0x6d,
	...
	0x76, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x44, 0x72, 0x69, 0x76, 0x65,
	0x72, 0x52, 0x06, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x06, 0x6d, 0x65, 0x6d,
	0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: v1.Storage.Driver
	(*Storage)(nil),     // 1: v1.Storage
	(*Memory)(nil),      // 2: v1.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: v1.Storage.driver:type_name -> v1.Storage.Driver
	2, // 1: v1.Storage.memory:type_name -> v1.Memory
