...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=v1.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x22, 0xa3, 0x01, 0x0a, 0x06, 0x4d,
	...
	0x6e, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: v1.Memory.Unit
	(*Memory)(nil),   // 1: v1.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: v1.Memory.unit:type_name -> v1.Memory.Unit
